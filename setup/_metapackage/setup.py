...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-fieldservice_fleet>=16.0dev,<16.1dev',
        ...
        'odoo-addon-fieldservice_stock_request>=16.0dev,<16.1dev',
